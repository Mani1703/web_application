...
st.executeUpdate("insert into mtable(item_id,username,address,phone_no,quantity,product_name) values('"+item_id+"','"+username+"','"+address+"','"+phone_no+"','"+quantity+"','"+product_name+"')");
