...
<table width="993" height="102" border="0">
    ...
    <td width="726" class="right">24X7 Customer Support - <a href="contact.jsp">Contact us</a> | <a href="home1.html">Home</a> |
...
<table width="450" height="142" border="0">
    ...
    <td width="342"><input type="text" name="item_id" size="30" value="f1" required/></td>
  </tr>
    <tr>
    <td height="32" align="right">Product Name</td>
    <td><input type="text" name="product_name" size="20" value="Velvet Heeled Shoe" required/></td>
    </tr>
